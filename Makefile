...
deploy :; forge script script/Deploy.s.sol --rpc-url ${DEPLOY_RPC_URL} --private-key ${PRIVATE_KEY} --broadcast --verify --verifier-url ${ETHERSCAN_API_URL} --verifier-api-key ${ETHERSCAN_API_KEY}
